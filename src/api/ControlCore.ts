...
namespace BoilerPlate {
    ...
    export abstract class ControlCore extends BaseControl implements IPrintFunction {
        ...
        protected originalValue: IPluginBoilerPlateFieldValue;
        ...
        */
        protected renderControl( readOnly:boolean, params?:IPluginBoilerPlatePrintParams) {
    
            // this are the options saved in the field setting, configuring the control
            let config = <IPluginBoilerPlateFieldParameter>this.settings.parameter;

            // here, we get the options defining the radio buttons
            let options:IPluginBoilerPlateFieldOptions = null;
            ...
            let value = <IPluginBoilerPlateFieldValue>this.originalValue;
        ...
        protected abstract renderPrint( fieldId:string, value:IPluginBoilerPlateFieldValue, options:IPluginBoilerPlateFieldOptions, params:IPluginBoilerPlatePrintParams );
        protected abstract renderEditor(  fieldId:string, value:IPluginBoilerPlateFieldValue, options:IPluginBoilerPlateFieldOptions );
        ...
        protected abstract isSame( a:IPluginBoilerPlateFieldValue, b:IPluginBoilerPlateFieldValue);
    ...
    <pre>
        ...
        render(overwrites:IGlobalPrintFunctionParams,  paramsCaller:IPluginBoilerPlatePrintParams, itemOrFolderRef:string, itemOrFolder:JQuery, mf:JQuery, globals:IPrintGlobals, possibleTargets:string[],  onError:(message:string)=> void) {

            let uid = PrintProcessor.getFieldFunctionId(Plugin.config.field.fieldType);
            const defaults:IPluginBoilerPlatePrintParams = {
                class: ""
            }
